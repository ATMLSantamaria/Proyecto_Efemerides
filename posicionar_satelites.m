...
function [ECEF_P_T,LLAT_rad]= posicionar_satelites(t,ephemeris)
format long
...
%week:                        895
mu=3.986005*10^14;%WGS 84 Parametro gravitacion universal
longitud=length(t);
...
%Longitud y latitud
[lon_lat] = ecef22lla(squeeze(ECEF_P_T(satt,:,:)),a,e,t); %VECTOR CON LONGITUD Y LATITUD PARA CADA INSTANTE DE TIEMPO

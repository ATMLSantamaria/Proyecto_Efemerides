...
%tiempo dado.
%Si quiere los satélites visibles en todos los momentos de tiempo por favor 
%vaya a la función totalgeometry4
function [ geometria,alfa_rad2,dis_sat_flat2 ] = geometry4( c,a )
% 
format long

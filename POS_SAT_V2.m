...
function [ECEF_P_T,LLAT_rad,LLAT_deg]=POS_SAT_V2(t,et,ephemeris)
format long
...
[lon_lat] = ecef22lla(squeeze(ECEF_P_T(satt,:,:)),a,e,t,et);%VECTOR CON LONGITUD Y LATITUD PARA CADA INSTANTE DE TIEMPO

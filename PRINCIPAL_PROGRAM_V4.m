...
coordenadas_urgel=[42.3587700,1.4614400,700];
coordenadas_san_petersburgo=[59.9339,30.3061,3];
coordenadas_quito=[-0.22985,-78.52495,2850]
%coordenadas_usuario=coordenadas_urgel;
%coordenadas_usuario = coordenadas_san_petersburgo;
coordenadas_usuario = coordenadas_quito;
[ecef_usuario ] = ecef_ruta( coordenadas_usuario );

clear coordenadas_usuario

angulo_mascara=10;
tiempo=55000;% s momento en el que queremos la posicion de los satelites
...
for tiempo=1:1:length(t)
    ...
    if (size(ecef_sat_vis_con_angulo_bucle,1)<6) %necesario para evitar el fallo del programa si hay menos de 5 satélites visibles en algun momento de la semana.
        continue
    end
